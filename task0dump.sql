...
DROP DATABASE IF EXISTS `task0` ;
CREATE DATABASE  IF NOT EXISTS `task0` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */; 
USE `task0`;
...
-- Dump completed on 2019-12-05  9:49:23