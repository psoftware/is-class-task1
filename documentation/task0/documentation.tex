...
\addcontentsline{toc}{section}{Database object classes}
...
\addcontentsline{toc}{subsubsection}{Transaction on DBManager (SQL)}
...
\addcontentsline{toc}{subsubsection}{JTA and Trigger Errors}
